...
def main():
    ...
    sgdr_min_lr = 0.0005  # 0.0001, 0.001
    sgdr_max_lr = 0.05  # 0.001, 0.03
    ...
    train_set_data_loader = DataLoader(train_set, batch_size=batch_size, shuffle=True, num_workers=8, pin_memory=True)

    val_set = TrainDataset(train_data.val_set_df, image_size_target, augment=False)
    val_set_data_loader = DataLoader(val_set, batch_size=batch_size, shuffle=False, num_workers=2, pin_memory=True)
