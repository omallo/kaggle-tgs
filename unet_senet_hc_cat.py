...
class UNetSeNetHcCat(nn.Module):
    def __init__(self, backbone, num_classes, input_size, num_filters=32, dropout_2d=0.2, pretrained=False):
        ...
        self.dec4 = DecoderBlock(dec_in_channels[0], dec_out_channels[0], dec_sizes[0], input_size)
        self.dec3 = DecoderBlock(dec_in_channels[1], dec_out_channels[1], dec_sizes[1], input_size)
        self.dec2 = DecoderBlock(dec_in_channels[2], dec_out_channels[2], dec_sizes[2], input_size)
        self.dec1 = DecoderBlock(dec_in_channels[3], dec_out_channels[3], dec_sizes[3], input_size)
